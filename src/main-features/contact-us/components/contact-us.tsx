                                ...
                                <Grid container spacing={1}>
                                    <Grid item xs={12} md={6}>
                                        <FormControl fullWidth error={formik.touched.name && Boolean(formik.errors.name)} size="small">
                                            <InputLabel htmlFor="outlined-adornment-title">{t<string>('contact_us.label_name')}</InputLabel>
                                            <OutlinedInput
                                                id="name"
                                                name="name"
                                            ...
                                            />
                                            {
                                                formik.touched.name && formik.errors.name ?
                                                    <FormHelperText id="component-helper-text">{t<string>(formik.errors.name)}</FormHelperText> : null
                                            }
                                        </FormControl>
                                    </Grid>
                                    ...
                                    <Grid item xs={12} md={6}>
                                        <FormControl fullWidth error={formik.touched.email && Boolean(formik.errors.email)} size="small">
                                            <InputLabel htmlFor="outlined-adornment-title">{t<string>('contact_us.label_email')}</InputLabel>
                                            <OutlinedInput
                                                id="email"
                                                name="email"
                                            ...
                                            />
                                            {
                                                formik.touched.email && formik.errors.email ?
                                                    <FormHelperText id="component-helper-text">{t<string>(formik.errors.email)}</FormHelperText> : null
                                            }
                                        </FormControl>
                                    </Grid>
                                    ...
                                    <Grid item xs={12}>
                                        <FormControl fullWidth error={formik.touched.subject && Boolean(formik.errors.subject)} size="small">
                                            <InputLabel htmlFor="outlined-adornment-title">{t<string>('contact_us.label_subject')}</InputLabel>
                                            <OutlinedInput
                                                id="subject"
                                                name="subject"
                                            ...
                                            />
                                            {
                                                formik.touched.subject && formik.errors.subject ?
                                                    <FormHelperText id="component-helper-text">{t<string>(formik.errors.subject)}</FormHelperText> : null
                                            }
                                        </FormControl>
                                    </Grid>
                                    ...
                                    <Grid item xs={12} md={12}>
                                        <FormControl fullWidth sx={{ mt: 3 }} error={formik.touched.message && Boolean(formik.errors.message)} size="small">
                                            <InputLabel htmlFor="outlined-adornment-amount">{t<string>('contact_us.label_message')}</InputLabel>
                                            <OutlinedInput
                                                id="message"
                                                name="message"
                                            ...
                                            />
                                            {
                                                formik.touched.message && formik.errors.message ?
                                                    <FormHelperText id="component-helper-text">{t<string>(formik.errors.message)}</FormHelperText> : null
                                            }
                                        </FormControl>
                                    </Grid>
                                    ...
                                    <Grid item xs={12} md={12}>
                                        ...
                                        />
                                        {
                                            formik.touched.captchaResponse && formik.errors.captchaResponse ?
                                                <FormHelperText className="red-color">{t<string>(formik.errors.captchaResponse)}</FormHelperText> : null
                                        }
                                    </Grid>

                                    <Grid item xs={12} md={12}>
                                        <LoadingButton loading={loading} fullWidth variant="contained" sx={{ mt: 3, mb: 2 }} color="neutral" type="submit">
