    ...
    <Grid item xs={12} sm={12}>
      <Card>
        ...
        <CardActions disableSpacing sx={{ backgroundColor: 'rgba(0, 0, 0, 0.74);' }}>
          ...
          <ExpandMore expand={expanded} onClick={handleExpandClick} aria-expanded={expanded} aria-label="show more" sx={{ color: '#fff' }}>
            <ExpandMoreIcon />
          </ExpandMore>
        </CardActions>
          ...
          <Grid item xs={12} sm={6}>
            <Box sx={{ '& > :not(style)': { m: 1 } }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
                ...
                <TextField id="input-with-sx" label="Message" variant="standard" fullWidth multiline rows={4} />
              </Box>
              <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
