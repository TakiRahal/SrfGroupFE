...
import {loadingResetInitPassword, resetInitSuccessPassword, resetPasswordInit} from "../../store/slice";
...
export default function ForgotPasswordInit (){
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            dispatch(resetPasswordInit({...values}))
                            ...
                            <Box sx={{ mt: 1, pb: 2 }}>
                                <form onSubmit={formik.handleSubmit}>
                                    <Grid container spacing={2}>
                                        <Grid item xs={12}>
                                            {
                                                resetInitSuccessPasswordSelector ? <Alert severity="success" sx={{my:2}}>{t<string>('forgot_password_init.message_send_mail_success')}</Alert> : null
                                            }
